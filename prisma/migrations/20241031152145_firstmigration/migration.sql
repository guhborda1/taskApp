-- CreateEnum
CREATE TYPE "Role" AS ENUM ('admin', 'user', 'adminEmpresa', 'vendedor');

-- CreateEnum
CREATE TYPE "KanbanStatus" AS ENUM ('BACKLOG', 'EM_PROGRESSO', 'CONCLUIDA', 'CANCELADA');
...
CREATE TABLE "Proposal" (
    ...
    "kanbanStatus" "KanbanStatus" NOT NULL DEFAULT 'BACKLOG',
    "companyId" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "_AdminCompanies_AB_unique" ON "_AdminCompanies"("A", "B");
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_sellerInCompanyId_fkey" FOREIGN KEY ("sellerInCompanyId") REFERENCES "Company"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_proposalId_fkey" FOREIGN KEY ("proposalId") REFERENCES "Proposal"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
